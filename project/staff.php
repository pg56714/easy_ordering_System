...
border-radius: 5px; 
		...
		<script>
			function aa(pag){
				...
				var name=document.getElementById("res_name_search").value;
				var t="staff1.php?res_name_search="+name+"&page="+pag;
				$.ajax({
					type:'GET',
					url:t,
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav ms-auto">
						...
						<li class="nav-item mx-0 mx-lg-1"><a class="nav-link py-3 px-0 px-lg-3 rounded fancytable" href="staff_insert.php">新增員工</a></li>
                    ...
                    <table>
                        <form>
                            <tr style='font-size:16px;'></tr>
                                <td>
                                    員工姓名：<input class="sm" type="text" id="res_name_search" name="res_name_search">
                                </td>
                                <td>
                                    <a href="javascript: aa();" onclick="aa()">
                                        <input type="button" class="sm input"  value="查詢">
                                    </a>
                                </td>
                            </tr>
                        </form>
