...
<?php
     ...
     $sql = "DELETE FROM `car` WHERE id='$x'";      
     $result = mysqli_query($conn, $sql);
	 
	 if($result = true )
	{echo"<Script>swal('已刪除此餐點','','success')</Script>";echo '<meta http-equiv=REFRESH CONTENT=1;url=car.php>'; }
    if($result = false )
	{echo"<Script>swal('刪除失敗','','error')</Script>";echo '<meta http-equiv=REFRESH CONTENT=1;url=car.php>'; }
