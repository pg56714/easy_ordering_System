        ...
        <nav class="navbar navbar-expand-lg bg-secondary text-uppercase fixed-top" id="mainNav">
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
					...
					<li class="nav-item mx-0 mx-lg-1"><a class="nav-link py-3 px-0 px-lg-3 rounded" href="car.php">購物車</a></li>
...
while($ra = mysqli_fetch_array($s)){
    ...
    <td>$row[name]</td>
    <td>$$row[dollar]</td>
    <td> <button><img src='upload/$ra[photo]' alt='無照片' width='200' height='150' onclick=location.href='./upload/$ra[photo]' ></button></td>";

	echo"<td>
	<input class='product_bt' style='cursor: pointer;' onclick=location='caradd.php?x=$row[shop_id]' value='加入購物車' type='button' /></input></td>";
