...
th.specalt {
    ...
    <body>
		...
		<?php
            ...
            $select = "SELECT * FROM `master_list` as mas left join `restaurant` as res on mas.res_id = res.res_id where mas.state != 0 and mas.state != 1 and mas.state != 2 and mas.email = '$email'";
            if($state!=""){
