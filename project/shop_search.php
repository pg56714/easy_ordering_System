...
border-radius: 5px; 
		...
		<script>
			function aa(pag){
				...
				var t="shop.php?name_search="+name+"&page="+pag;
				$.ajax({
					type:'GET',
					url:t,
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav ms-auto">
						...
						<li class="nav-item mx-0 mx-lg-1"><a class="nav-link py-3 px-0 px-lg-3 rounded" href="shop_insert.php">新增餐點</a></li>
                    ...
                    <div class="t1">
                        <form>
                            <tr style='font-size:16px;'></tr>
                                <p>
                                    餐點名稱：<input type="text" class="sm input" id="name_search" name="name_search">
                                
                                
                                    <a href="javascript: aa();" onclick="aa()">
                                        <input type="button" style="background-color:#30D5C8"  class="sm input" value="查詢">
                                    </a>
                                </p>
