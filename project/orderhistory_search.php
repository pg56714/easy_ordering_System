    ...
    <title>店家首頁</title>
		...
		<script>
			function aa(pag){
				...
				var t="orderhistory.php?name_search="+name+"&state_search="+state+"&page="+pag;
				$.ajax({
					type:'GET',
					url:t,
                ...
                <center>
                    ...
                    <div style="width: 80%; background-color: #F5F5F5; padding: 5px; margin: 0px auto;padding: 15px;box-shadow: 5px 5px 5px 5px grey;" >
                        <form>
                                    ...
                                    <p class="t1">信箱：<input class="sm input" style="background-color:White;width:57%;" type="text" id="name_search" name="name_search"></p>
                               

								<p class="t1">狀態：<select name="state_search" id="state_search"   class="form-select-lg mb-3 border-" style="width:57%;" align="center">
                                    ...
                                    <a href="javascript: aa();" onclick="aa()">
                                        <input type="button" class="sm input t1" style="background-color:#30D5C8" value="查詢">
                                    </a>
